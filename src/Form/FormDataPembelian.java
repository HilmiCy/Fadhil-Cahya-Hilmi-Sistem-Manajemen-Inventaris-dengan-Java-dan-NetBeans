...
public class FormDataPembelian extends javax.swing.JInternalFrame {
    ...
    public FormDataPembelian() {
        super("Menu Form Data Pembelian |Administrator Fadhil Cahya Hilmi");
        initComponents();
    }
...
int id = 0, saham1 = 0;
    ...
    String kodea=this.kodeBarangTF.getText();
    ...
    String h_belia=this.hargaBeliTF.getText();
    totalStokTF.setText(Integer.toString(stoka1));
    jumlahBeliTF.setText(Integer.toString(j_beli1));
    String saham = Integer.toString(saham1);

    String stoka=this.totalStokTF.getText();
    ...
    try {
        Connection c = ClassDatabase.getkoneksi();
        String sql = "INSERT INTO acc (no_beli, kodea, j_beli, tgl_beli, kodesup) VALUES (?,?,?,?,?)";
        PreparedStatement p =(PreparedStatement) c.prepareStatement(sql);
//                                p.setInt(1, id);
        p.setString(1, no_beli);
        p.setString(2, kodea);
        p.setString(3, j_beli);
    ...
    try {
        Connection c = ClassDatabase.getkoneksi();
        Statement s = c.createStatement();
        String sql = "SELECT id, no_beli, kodea, j_beli, tgl_beli, kodesup FROM acc";
        ResultSet r = s.executeQuery(sql);
        ...
        try {
            Connection c=ClassDatabase.getkoneksi();
            String sql ="UPDATE `fadhil`.`master` SET `stok`=?, `saham`=? WHERE kode_barang=?";
            PreparedStatement p=(PreparedStatement) c.prepareStatement(sql);
            p.setString(3, kodea);
            p.setString(1, stoka);
            p.setString(2, saham);
    ...
    private void editBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBTActionPerformed
        ...
        try {
            Connection c = ClassDatabase.getkoneksi();
            Statement s= c.createStatement();
            String sql = "select j_beli from acc where no_beli = '" + this.noBeliTF.getText() + "'";
            ResultSet r =s.executeQuery(sql);
            while (r.next()){
        ...
        java.util.Date tgl_beli = (java.util.Date) this.tglBeliTF.getDate();
        String no_beli = this.noBeliTF.getText();
        String jumlah_beli = this.jumlahBeliTF.getText();
        String kdsup = this.kodeSupplierTF.getText();
        String kdbarang = this.kodeBarangTF.getText();
        int stok1 = Integer.parseInt(totalStokTF.getText());
        int j_beli1 = Integer.parseInt(jumlahBeliTF.getText());
        int hrgbeli1 = Integer.parseInt(hargaBeliTF.getText());
        
        int jumlah_beli1 = 0;
        stokpanel = Integer.parseInt(this.jumlahBeliTF.getText());
        ...
        if (noBeliTF.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "data belum lengkap,nomor pembelian tidak boleh kosong");
                ...
                try {
                    ...
                    tbltampil.addColumn("Tangggal Beli");
                    ...
                    if (stokdb > stokpanel) {
                        ...
                        stok1 -= jumlah_beli1;
                        saham1 = (stok1 + jumlah_beli1) *hrgbeli1;
                    ...
                    stok2 -= jumlah_beli2;
                    saham2 = (stok2 + jumlah_beli2) * hrgbeli1;
    ...
    private void deleteBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTActionPerformed
        ...
        int total_stok = Integer.parseInt(totalStokTF.getText());
        int hrg_beli=Integer.parseInt(hargaBeliTF.getText());
        
        hapus_stok = total_stok - jumlah_beli;
        saham = (hapus_stok)*hrg_beli;
